...
export function generateMetadata({ params: { slug, locale } }: BlogParams) {
	let post = getPosts(['src', 'app', '[locale]', 'recipes', 'posts', locale]).find((post) => post.slug === slug)
...
export default function Blog({ params }: BlogParams) {
	...
	let post = getPosts(['src', 'app', '[locale]', 'recipes', 'posts', params.locale]).find((post) => post.slug === params.slug)
