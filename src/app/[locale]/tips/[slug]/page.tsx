...
export function generateMetadata({ params: { slug, locale } }: BlogParams) {
	let post = getPosts(['src', 'app', '[locale]', 'tips', 'posts', locale]).find((post) => post.slug === slug)
...
export default function Blog({ params }: BlogParams) {
	...
	let post = getPosts(['src', 'app', '[locale]', 'tips', 'posts', params.locale]).find((post) => post.slug === params.slug)
